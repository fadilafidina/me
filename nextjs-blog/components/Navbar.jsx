...
const Navbar = () => {
    const [displayNavbar, setDisplayNavbar] = useState(false); // for small screens
    ...
    const toggleButton = <button onClick={handleToggleNavbar} type='button' class='inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600' aria-controls='navbar-default' aria-expanded='false'>
        <span class='sr-only'>Open main menu</span>
        <svg class='w-6 h-6' aria-hidden='true' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path fill-rule='evenodd' d='M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z' clip-rule='evenodd'></path></svg>
    </button>;

    const links = <div class='w-full md:block md:w-auto' id='navbar'>
    ...
    if (useNewNavBar) {
        return (
            <nav class='bg-slate-50 border-gray-200 px-1 sm:px-8 py-4 rounded dark:bg-gray-800'>
                <div class='container sm:px-0 px-8 flex flex-wrap justify-between items-center mx-auto'>
                    <Link href='/' class='flex items-center'>
                        <span class='self-center text-base font-semibold whitespace-nowrap dark:text-white text-gray-700'>Fadila Fidina 💫</span>
                    </Link>
                    {toggleButton}
                    {displayNavbar && links}
